            ...
            <div className="bg-gradient-to-r from-emerald-600/90 via-green-600/90 to-emerald-600/90 backdrop-blur-xl rounded-3xl p-10 text-white text-center max-w-6xl mx-auto border border-emerald-400/50 shadow-2xl">
              <div className="relative z-10">
                ...
                <p className="text-xl md:text-2xl leading-relaxed">
                  ...
                  of development time on fragmented tools. Our research shows a
                  $59.4B market opportunity where agile project management
                  ($5.2B growing at 12.6% CAGR), no-code/low-code development
                  ($32B growing at 28% CAGR), and AI development tools ($22.2B
                  growing at 25% CAGR) are converging into a single platform
                  need.
                </p>
              </div>
            </div>
