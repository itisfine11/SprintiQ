...
const termsSections = [
  {
    ...
    content: `
      <p>Welcome to <a href="https://www.sprintiq.ai" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:text-emerald-300"><u>SprintiQ</u></a>, an AI-native agile planning and story generation platform operated by SprintiQ ("Company," "we," "us," or "our"). These <a href="https://www.sprintiq.ai/terms" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:text-emerald-300"><u>Terms of Service</u></a> ("Terms") govern your use of our website, mobile application, and related services (collectively, the "Service").</p>
      <p>By accessing or using SprintiQ, you ("User," "you," or "your") agree to be bound by these Terms and our <a href="https://www.sprintiq.ai/privacy" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:text-emerald-300"><u>Privacy Policy</u></a>. If you do not agree to these Terms, you may not access or use the Service.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul class="list-disc list-inside space-y-2 mt-4">
        <li>AI-Native user story generation using Claude AI technology</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul class="list-disc list-inside space-y-2 mt-4">
        ...
        <li>Generate AI-Native recommendations and insights</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul class="list-disc list-inside space-y-2 mt-4">
        ...
        <li>AI-native agile planning and risk assessment</li>
      </ul>
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>YOU AGREE THAT DISPUTES WILL BE RESOLVED ON AN INDIVIDUAL BASIS AND WAKE YOUR RIGHT TO PARTICIPATE IN CLASS ACTIONS, COLLECTIVE ARBITRATIONS, OR REPRESENTATIVE PROCEEDINGS.</strong></p>
  ...
  },
  {
    ...
    content: `
      <p>For questions about these <a href="https://www.sprintiq.ai/terms" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:text-emerald-300"><u>Terms</u></a> or the Service, please <a href="https://www.sprintiq.ai/contact" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:text-emerald-300"><u>contact us</u></a>:</p>
...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 overflow-y-auto custom-scrollbar relative">
      ...
      {/* Floating Hover Menu - Hidden on Mobile */}
      ...
      <div className="lg:hidden fixed bottom-4 left-4 right-4 z-50">
        ...
        >
          <ScrollArea className="p-4 max-h-32">
            <div className="flex space-x-2 overflow-x-auto pb-2">
              {termsSections.slice(0, 8).map((section, index) => (
                <motion.button
                  key={section.id}
                  onClick={() => scrollToSection(section.id)}
              ...
              >
                ...
                <Card className="bg-white/5 backdrop-blur-xl border border-emerald-500/20 shadow-2xl shadow-emerald-500/10 overflow-hidden">
                  <CardContent className="p-6 sm:p-8 lg:p-10">
                    <div
                      className="text-emerald-100/90 leading-relaxed prose prose-invert max-w-none text-base sm:text-lg [&>h3]:text-[20px] sm:[&>h3]:text-[24px] [&>h3]:font-bold [&>h3]:text-emerald-300 [&>h3]:mb-3 sm:[&>h3]:mb-4 [&>h3]:mt-4 sm:[&>h3]:mt-6 [&>p]:text-sm sm:[&>p]:text-base [&>ul]:text-sm sm:[&>ul]:text-base [&>li]:text-sm sm:[&>li]:text-base"
