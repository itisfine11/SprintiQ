      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center relative z-10">
        ...
        <div className="w-full max-w-md mx-auto lg:max-w-none">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-emerald-500/20 hover:border-emerald-500/30 transition-all duration-300">
            ...
            {mcpToken && (
              <div className="mb-6 p-3 sm:p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
            ...
            <Button
              variant="outline"
              className="w-full flex items-center justify-center h-11 sm:h-12 bg-emerald-950/30 border-emerald-500/30 text-white hover:bg-emerald-950/40 hover:text-emerald-300 hover:border-emerald-400/50 rounded-xl transition-all duration-200 hover:scale-[1.02]"
