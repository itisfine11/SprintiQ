...
NEXT_PUBLIC_APP_URL=https://www.sprintiq.ai
...
- **MCP Server**: `https://www.sprintiq.ai/api/mcp/server`
- **Enhanced MCP**: `https://www.sprintiq.ai/api/mcp/enhanced`
- **User Validation**: `https://www.sprintiq.ai/api/mcp/validate-user`
- **Auth Callback**: `https://www.sprintiq.ai/api/mcp/auth/callback`

### Health Check

```bash
curl https://www.sprintiq.ai/api/mcp/server
```
...
```json
{
  "mcpServers": {
    "sprintiq-production": {
      ...
      "env": {
        "SPRINTIQ_MCP_URL": "https://www.sprintiq.ai/api/mcp/server",
        "NODE_ENV": "production"
      }
    }
  }
...
const MCP_SERVER_URL =
  process.env.SPRINTIQ_MCP_URL || "https://www.sprintiq.ai/api/mcp/server";
...
curl -I https://www.sprintiq.ai/api/mcp/server
```
...
- **Documentation**: `https://www.sprintiq.ai/docs/mcp`
- **Support**: `support@your-domain.com`
- **Status Page**: `https://www.sprintiq.ai/status`
...
1. **Register**: Sign up at `https://www.sprintiq.ai/signup`
