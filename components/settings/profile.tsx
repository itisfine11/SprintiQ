                  ...
                  <div className="flex gap-2">
                    ...
                    {(profile?.avatar_url || croppedImageUrl) && (
                      <Button
                        ...
                        disabled={isLoading}
                        className="text-red-600 hover:text-red-700 hover:bg-red-50 workspace-header-bg border workspace-border"
                      >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-9 workspace-header-bg border workspace-border"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-9 pr-10 workspace-header-bg border workspace-border"
                      value={newPassword}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="outline"
                        className="w-full justify-between workspace-header-bg border workspace-border"
                      >
                        <Globe className="mr-2 h-4 w-4" />
                        {language}
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="w-[var(--radix-dropdown-menu-trigger-width)] p-2 space-y-1 workspace-header-bg border workspace-border">
                      <DropdownMenuItem
                ...
                <div>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-[var(--radix-dropdown-menu-trigger-width)] workspace-header-bg border workspace-border">
                      <div className="p-2 w-full">
                        <Input
                          ...
                          className="w-full mb-2 workspace-header-bg border workspace-border"
                        />
                      </div>
                        ...
                        {(Array.isArray(timezones) ? timezones : [])
                          ...
                          .map((tz) => (
                            <DropdownMenuItem
                              ...
                              className="w-full flex items-center justify-between hover:workspace-hover cursor-pointer workspace-header-bg"
                            >
                              <span>
