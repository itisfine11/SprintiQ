...
import { ChevronDown, Inbox, Mail, Monitor, Save, Loader2 } from "lucide-react";
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-lg border workspace-border p-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="w-[140px] justify-between text-xs p-2 h-8 workspace-header-bg border workspace-border"
                  disabled={isPending}
                >
                  {inboxNotifications}
              ...
              <DropdownMenuContent className="w-[140px] workspace-header-bg border workspace-border">
          ...
          <div className="flex items-center justify-between rounded-lg border workspace-border p-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={isPending}
                className="text-xs p-2 h-8 w-[140px] workspace-header-bg border workspace-border"
              >
                {browserNotificationsEnabled
        ...
        <div className="flex items-center justify-between rounded-lg border workspace-border p-4">
          ...
          <Button
            ...
            className="text-xs p-2 h-8 w-[140px] gap-1 workspace-header-bg border workspace-border"
          >
            <SlackSvg />
            {isConnectingSlack
              ? "Connecting..."
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className="text-xs workspace-header-bg border workspace-border p-2 h-8"
              >
            ...
            {channelMappings.length > 0 ? (
              <div className="space-y-2">
                {channelMappings.map((mapping) => (
                  <div
                    key={mapping.id}
                    className="flex items-center justify-between p-3 border workspace-border rounded-lg"
                  >
                    <div>
                    ...
                    <Button
                      ...
                      className="text-xs text-red-600 p-2 h-8 hover:text-red-700 workspace-header-bg border workspace-border"
                    >
                      Remove
                    </Button>
                  </div>
