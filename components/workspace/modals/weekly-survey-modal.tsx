...
export default function WeeklySurveyModal({ open, onClose, userId }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl mx-auto p-0 border-0 rounded-2xl shadow-2xl overflow-hidden workspace-secondary-sidebar-bg">
        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center py-20 px-8">
            ...
            <div className="workspace-sidebar-text text-center max-w-md">
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            {step === 1 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Time Investment */}
                <div className="rounded-xl p-5 shadow-sm border workspace-border">
                  ...
                  <Input
                    ...
                    max={40}
                    required
                    className="mt-1 border workspace-border workspace-secondary-sidebar-bg"
                  />
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-medium shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 
                          ${
                            selected
                              ...
                              : "workspace-sidebar-text border-gray-200 hover:workspace-component-bg hover:border-workspace-primary hover:text-workspace-primary"
                          }
                        `}
                    ...
                    <label
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer border transition-all duration-150 text-sm font-medium shadow-sm ${
                        weeklyData.wouldRecommend === true
                          ...
                          : "border-gray-200 workspace-sidebar-text hover:workspace-component-bg hover:workspace-component-active-border"
                      }`}
                    >
                      <Input
                        type="radio"
            ...
            {/* Stepper Navigation */}
            <div className="flex justify-between gap-3 pt-8 mt-8 border-t workspace-border sticky bottom-0 z-10">
              {step === 1 ? (
                <div className="flex items-center">
                  ...
                  <label
                    ...
                    className="text-sm workspace-sidebar-text select-none cursor-pointer"
                  >
                    Remind me later
                  </label>
                </div>
