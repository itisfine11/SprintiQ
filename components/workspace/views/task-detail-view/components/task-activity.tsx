    ...
    <div className="w-80 border-l workspace-border p-3 overflow-y-auto flex flex-col">
      ...
      <div className="mt-2 pt-3 border-t workspace-border text-xs relative">
        <Textarea
          ...
          className="w-full text-xs workspace-sidebar-text workspace-header-bg border workspace-border placeholder:text-xs resize-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:ring-2 focus:workspace-ring"
          value={commentText}
