...
import ImportJiraTeamModal from "./modals/import-jira-team-modal";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function TeamsSidebar({
  ...
  const [isImportJiraTeamModalOpen, setIsImportJiraTeamModalOpen] =
    useState(false);
  ...
  const handleJiraImport = () => {
    setIsImportJiraTeamModalOpen(true);
  };
  ...
  return (
    <div className="w-80 workspace-secondary-sidebar-bg border-r workspace-border flex flex-col h-full">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                {team.type === "jira" && (
                  <div className="w-5 h-5 workspace-component-bg rounded-md p-1">
                    <JiraSvg />
                  </div>
                )}
              </div>
      ...
      <ImportJiraTeamModal
        open={isImportJiraTeamModalOpen}
        onOpenChange={setIsImportJiraTeamModalOpen}
        roles={roles}
        levels={levels}
