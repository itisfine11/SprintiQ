      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex items-center gap-2 workspace-header-bg border workspace-border"
          >
        ...
        {mode === "create" ? (
          ...
          <div className="space-y-4 p-4 border workspace-border rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select value={newMember.role} onValueChange={handleRoleChange}>
                  <SelectTrigger className="workspace-header-bg border workspace-border">
            ...
            <Button
              ...
              className="w-full workspace-header-bg border workspace-border"
              variant="workspace"
            >
            ...
            {isLoadingExisting ? (
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-10 workspace-header-bg border workspace-border"
                  />
                  {searchQuery && (
                    <Button
                      variant="ghost"
                      ...
                      className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 hover:bg-muted workspace-header-bg border workspace-border"
                    >
                      <X className="h-4 w-4" />
                    </Button>
                  )}
                ...
                {filteredTeamMembers.length > 0 && (
                  <div className="flex gap-3">
                    <Button
                      ...
                      className="flex-1 h-9 workspace-header-bg border workspace-border"
                      variant="outline"
                      size="sm"
                    >
                ...
                <ScrollArea className="h-80">
                  {filteredTeamMembers.length > 0 ? (
                    filteredTeamMembers.map((member) => (
                      <div
                        key={member.id}
                        className={`group relative p-4 mb-2 border rounded-lg transition-all duration-200 hover:shadow-sm workspace-header-bg ${
                          selectedExistingMembers.has(member.id)
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex justify-between mb-2">
                              <div className="flex items-center gap-2">
                                ...
                                <Badge
                                  variant="outline"
                                  className="text-xs px-2 py-0.5 border workspace-border"
                                >
                                  {member.role}
                                </Badge>
                                <Badge
                              ...
                              <Badge
                                variant="outline"
                                className="text-xs px-2 py-0.5 flex items-center gap-1 border workspace-border"
                              >
                            ...
                            <div className="flex flex-wrap gap-1">
                              {member.skills.slice(0, 4).map((skill) => (
                                <Badge
                                  key={skill}
                                  variant="outline"
                                  className="text-xs px-2 py-0.5 workspace-header-bg border workspace-border"
                                >
                                  {skill}
                                </Badge>
                              ))}
                ...
                <Button
                  ...
                  className="w-full h-10 workspace-header-bg border workspace-border"
                  variant="workspace"
                >
              ...
              <div className="text-center py-8">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => window.open(`/${workspaceId}/teams`, "_blank")}
                >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {teamMembers.map((member) => (
                <div
                  key={member.id}
                  className="group relative p-4 border workspace-border rounded-lg hover:shadow-sm transition-all duration-200 workspace-header-bg"
                >
                  <div className="flex items-start gap-3">
                    <Avatar className="h-10 w-10">
                      <AvatarFallback className="text-xs font-bold text-workspace-primary workspace-component-bg">
