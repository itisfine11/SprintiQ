...
export default function HeroSection() {
  ...
  const boardView = () => {
    return (
      <div className="grid grid-cols-3 gap-2 sm:gap-4 h-full px-4 pt-4 pb-8">
        {[
          {
            title: "Backlog",
            count: 7,
  ...
  const agentView = () => {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 h-full px-4 pt-4 pb-8">
        <motion.div
          className="bg-white/5 rounded-lg p-3 hover-glow"
          whileHover={{ scale: 1.05 }}
          initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              {/* Main Dashboard Card */}
              <motion.div
                className="relative glass-morphism-dark rounded-2xl shadow-2xl animate-dashboard-pulse hover-lift h-[450px] sm:h-[500px]"
              ...
              >
                ...
                {/* Content Grid */}
                <div className="h-full flex w-full pb-12">
                  <div className="pl-4 pb-8">
                    <motion.div
                      className="bg-white/5 rounded-lg p-3 hover-glow h-full"
                      whileHover={{ scale: 1.05 }}
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                    >
